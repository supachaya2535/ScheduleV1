...
namespace AppointmentQueue
{
    class Appointment
    {
        ...
        public Appointment(DateTime startT, string HN, string req, string paid, DateTime birthDate, string pstatus,string scan, int scannum, DataTable dt)
        {
            this.startT = startT;
            this.duraT = startT;
            this.patientHN = HN;
